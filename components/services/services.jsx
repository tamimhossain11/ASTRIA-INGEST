...
const Services = () => {
	return (
		<div>
			{/* <!-- Services --> */}
			<section className="py-24 dark:bg-black-900">
				<div className="container">
					<div className="mx-auto mb-12 max-w-xl text-center">
						<h2 className="mb-6 text-center font-display text-3xl font-medium text-jacarta-700 dark:text-white">
							Start Improving Your Investigation Today
						</h2>
						<p className="text-lg dark:text-jacarta-300">
							Connect our brand new release forensics automation system and get Astria Ingest app
							work while you just away
						</p>
					</div>
