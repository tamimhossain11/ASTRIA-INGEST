...
const profile = () => {
  ...
  return (
    <div>
      <Meta title="Profile || MyScope | NFT Marketplace Next.js Template" />
      <div className="pt-[5.5rem] lg:pt-24">
        ...
        <div className="relative">
          <Image
            ...
            height={300}
            priority
            src={coverPreview ? coverPreview : "/images/bgprofile.jpg"}
            alt="banner"
        ...
        {/* <!-- end banner --> */}
        {/* <!-- Edit Profile --> */}
        <section className="dark:bg-black-900 relative py-16">
              ...
              <div className="flex space-x-5 md:w-1/2 md:pl-8">
                <form className="shrink-0">
                  <figure className="relative inline-block">
                    <Image
                      src={preview ? preview : "/images/404.png"}
