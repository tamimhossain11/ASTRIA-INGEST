        ...
        <div className="container ">
          ...
          <div className="mx-auto max-w-[48.125rem]">
            ...
            <div className="mb-6">
              ...
              >
               Case Name<span className="text-red">*</span>
              </label>
              <input
                type="text"
                id="case-name"
            ...
            <div className="mb-6">
              ...
              <p className="dark:text-jacarta-300 text-2xs mb-3">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                 Velit omnis in quas corporis fuga incidunt voluptatem perferendis reprehenderit amet porro.
              </p>
              <input
                type="url"
            ...
            <div className="mb-6">
              ...
              <p className="dark:text-jacarta-300 text-2xs mb-3">
                The description will be included on the {"Case's"} detail page
                      ...
                      <Tippy
                        content={
                          <span>
                            ...
                            search while browsing Astria Ingest
                          </span>
                        }
                      >
...
*/}
            ...
            <button
              disabled
              className="bg-[#000000] cursor-default rounded-sm py-2 px-8 text-center font-semibold text-white transition-all"
            >
              Create Case
            </button>
          </div>
